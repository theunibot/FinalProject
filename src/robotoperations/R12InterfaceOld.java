...
public class R12InterfaceOld {
	...
	private static R12InterfaceOld r12Interface = null;
	...
	public Result init(String address, int port) {
		...
		try {
			...
			Logger.getLogger(R12InterfaceOld.class.getName()).log(Level.SEVERE, null, ex);
	...
	public static R12InterfaceOld getInstance() {
		if (r12Interface == null)
			r12Interface = new R12InterfaceOld();
		return r12Interface;
	}
