 ...
 *
 */
public class R12OperationsOld {
	//Command Objects
	private R12InterfaceOld r12i = null;
	private static R12OperationsOld r12Operations = null;
...
//        System.out.println("Read Buffered: " + s);
	...
	public static R12OperationsOld getInstance() {
		if (r12Operations == null)
			r12Operations = new R12OperationsOld();
