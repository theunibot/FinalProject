...
public class RouteCompiler
{
    ...
    public boolean init()
    {
        ...
        for (String prefix : ROUTE_FILE_PREFIXS)
        {
            ...
            ArrayList<RouteObjectList> routes = parseLines(lines, prefix);
    ...
    private ArrayList<RouteObjectList> parseLines(ArrayList<String> lines, String prefix)
    {
        ...
        for (String line : lines)
        {
            ...
            else if (currentRouteObjectList != null)//not defining a new command, so a cartesian command
            {
                ...
                if (pieces.length == 3)//x,y,z only
                {
                    ...
                    pieces[0] = GeneralUtils.xyInToMmStr(pieces[0]);
                    pieces[1] = GeneralUtils.xyInToMmStr(pieces[1]);
                    pieces[2] = GeneralUtils.xyInToMmStr(pieces[2]);
