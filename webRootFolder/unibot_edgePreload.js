...
if(document.addEventListener ){ 
   ...
   aLoader = [
      ...
      { load: "js/jquery.transit.min.js", user: true },
      { load: "js/modernizr.custom.13617.js", user: true },
      { load: "js/jquery.cookie.js", user: true },
      { load: "unibot_edge.js"},
      { load: "unibot_edgeActions.js"}];
...
var plSTF="both",ctrPlS="none",minPlW="0",maxPlW=undefined,plWidth="512px",plHeight="384px";
